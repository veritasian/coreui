...
const STEP_TITLES = [
  ...
  ['安装引擎', '引擎从官方 GitHub 下载预编译包。装完点「检测」确认。'],
...
function buildDocHTML() {
  ...
  <h3>第 2 步：装引擎</h3>
  <p>引擎就是“让模型跑起来的程序”。<strong>从官方 GitHub 下载预编译包</strong>：</p>
  <ul class="doc-list">
    <li>点引擎卡片上的「下载预编译包」，或去官方 GitHub 手动下载后放进对应目录。</li>
  ...
  <h3>常见问题</h3>
  <ul class="doc-list">
    <li><b>检测显示没装好？</b> 先确认引擎预编译包已下载放好；再点「检测」看一次。</li>
